...
left_join(second,new) %>% ggplot(mapping = aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_year,fill=as.factor(YEAR)))+geom_bar(stat = 'identity',position = 'dodge')+coord_flip()+labs(fill='YEAR')+labs(title = 'Change in number of incidents of each crime',x='Crime',y='number of incidents reported',fill='Crime')+geom_text(aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_year+500,label = round(crimes_in_respective_year, 2)),, position = position_dodge(0.9),vjust = 0.5)
...
left_join(third,new) %>% ggplot(mapping = aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_month,fill=as.factor(MONTH)))+geom_bar(stat = 'identity',position = 'dodge')+coord_flip()+labs(fill='MONTHS IN AN YEAR',x='Month',y='Numbe of crimes reported',title = 'Months in which each of Top-5 crimes is frequently reported')+geom_text(aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_month+250,label = round(crimes_in_respective_month, 2)), position = position_dodge(0.9),vjust = 0.5)
...
left_join(fourth,new) %>% ggplot(mapping = aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_day_of_week,fill=as.factor(DAY_OF_WEEK)))+geom_bar(stat = 'identity',position = 'dodge')+coord_flip()+labs(fill='DAY OF WEEK')+labs(fill='Day in a week',x='Crime',y='Numbe of crimes reported')+geom_text(aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_day_of_week+500,label = round(crimes_in_respective_day_of_week, 2)), position = position_dodge(0.9),vjust = 0.5)
...
left_join(fifth,new) %>% ggplot(mapping = aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_date_in_month,fill=as.factor(date)))+geom_bar(stat = 'identity',position = 'dodge')+coord_flip()+labs(title='Dates on which most number of Top-5 crimes reported',x='Crime',y='Number of crimes reported',fill='DATE IN MONTH')+geom_text(aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_date_in_month+100,label = round(crimes_in_respective_date_in_month, 2)), position = position_dodge(0.9),vjust = 0.5)
...
left_join(sixth,new) %>% ggplot(mapping = aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_hour_in_day,fill=as.factor(HOUR)))+geom_bar(stat = 'identity',position = 'dodge')+coord_flip()+labs(fill='HOUR IN DAY',x='Crime',y='Number of incidents reported',title='Hour of a day in which each of Top-5 crimes has occurred')+geom_text(aes(x=OFFENSE_CODE_GROUP,y=crimes_in_respective_hour_in_day+150,label = round(crimes_in_respective_hour_in_day, 2)), position = position_dodge(0.9),vjust = 0.5)
